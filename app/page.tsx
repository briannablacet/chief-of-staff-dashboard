    ...
    <div className="flex min-h-svh bg-background">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-10 flex items-center gap-3 border-b border-border bg-background/80 px-4 py-3 backdrop-blur md:px-6">
          ...
          <h1 className="text-sm font-semibold text-foreground md:text-base">{TITLES[view]}</h1>
          <div className="ml-auto flex items-center gap-1.5">
            <Button variant="ghost" size="icon" aria-label="Search" className="text-muted-foreground">
              <Search />
            </Button>
            <Button
              variant="ghost"
